...
/*
 * Die Grenze. Stand beim Einbau (nach Flaeche 8): font-size 84, padding 76,
 * gap 46, margin 52, min-height 13. Wer eine senkt, zieht die Zahl hier nach.
 */
const LIMIT = { 'font-size': 84, padding: 76, gap: 46, margin: 52, 'min-height': 13 };
const count = (prop) =>
